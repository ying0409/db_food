...
?>	
    ...
    <button><a href="manager_exit_shop.php"  style="text-decoration:none;">編輯</a></button>
    <button><a href="manager_delete_shop.html"  style="text-decoration:none;">刪除</a></button>
</body>
</html>
